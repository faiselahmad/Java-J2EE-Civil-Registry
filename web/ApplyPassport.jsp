...
<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header text-center">Passport Portal</h3></div>
          </div>
...
if(rs.next()){
    String passportstatus =rs.getString(4);
       if(passportstatus.equalsIgnoreCase("Waiting") || passportstatus.equalsIgnoreCase("Update")){
       %>
      
          <!----------waiting-------------->  
          
         <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">Passport Status</h2>
             <h2><span class="label label-primary text-capitalize">Your Passport is Waiting process yet...</span></h2>
                </div>
           <%
       
       }
else if(passportstatus.equalsIgnoreCase("Accepted")){
 %>
...
else if(passportstatus.equalsIgnoreCase("Generated")){
%>      
      ...
      <!-----------------------------------------generated-------------------------------------->
                             ...
                             <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">Passport Status</h2>
  <h2><span class="label label-primary text-capitalize">congratulation! your Passport hasbeen generated, to download</span></h2>
  <a href="DownloadId?cid=<%=cid%>&documentname=PASSPORT" class=" btn btn-success">click here </a>
                </div>
          <%
}
...
All the document should be verified first otherwise you won't be able to generate any ID 
          ...
          <h2><span class="label label-warning">Your Passport has been rejected</span></h2>
            <div class="row" >
         <div class="col-lg-12">
        <div class="panel panel-default">
                <div class="panel-heading" align="center"><b><u>Apply for Passport</u></b></div>
	 ...
	 <div class="form-group">
                ...
                <br>
                  <input type="hidden" name="documentname" value="passport" ><!-- chk whether
