...
<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header text-center">PAN Card Portal</h3></div>
          </div>
...
if(rs.next()){
    String pancardstatus =rs.getString(4);
       if(pancardstatus.equalsIgnoreCase("Waiting") || pancardstatus.equalsIgnoreCase("Update")){
       %>
      
          <!----------waiting-------------->  
         <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">PAN Card Status</h2>
             <h2><span class="label label-primary text-capitalize">Your PANCard is Waiting process yet...</span></h2>
                </div>
        
            <%
       
       }
else if(pancardstatus.equalsIgnoreCase("Accepted")){
 %>
                  <!----------accepted-------------->  
                  <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">PANCard Status</h2>
  <h2><span class="label label-primary text-capitalize">Well done! your request is accepted by our department  </span></h2>
                </div>
                  <%
}
else if(pancardstatus.equalsIgnoreCase("Generated")){
%>
                          ...
                          <!----------generated-------------->  
                             <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">PANCard Status</h2>
  <h2><span class="label label-primary text-capitalize">congratulation! your PANCard hasbeen generated, to download</span></h2>
  <a href="DownloadId?cid=<%=cid%>&documentname=PANCARD" class=" btn btn-success">click here </a>
                </div>
...
All the document should be verified first otherwise you won't be able to generate any ID 
          ...
          <h2><span class="label label-warning">Your PANCard has been rejected</span></h2>
            <div class="row" >
         <div class="col-lg-12">
        <div class="panel panel-default">
                <div class="panel-heading" align="center"><b><u>Apply for PANCard</u></b></div>
	 ...
	 <div class="form-group">
                ...
                <br>
                  <input type="hidden" name="documentname" value="pancard" ><!-- chk whether
