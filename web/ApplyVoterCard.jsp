...
<div class="row">
        <div class="col-lg-12">
            <h3 class="page-header text-center">Voter Card Portal</h3></div>
          </div>
   ...
   String msg=(String)session.getAttribute("msg"); 
    ...
    <h4 class="panel-title text-center"> <%=msg%></h4>
      ...
      %>
          ...
          <%                   
PreparedStatement checkVoterUserCid=(PreparedStatement)application.getAttribute("checkVoterUserCid");
checkVoterUserCid.setInt(1,cid);

ResultSet rs=checkVoterUserCid.executeQuery();

if(rs.next()){
    String Voterstatus =rs.getString(4);
                if(Voterstatus.equalsIgnoreCase("Waiting") || Voterstatus.equalsIgnoreCase("Update") ){
       %>
      
          <!----------waiting-------------->  
         <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">Voter Card Status</h2>
             <h2><span class="label label-primary text-capitalize">Your Votercard is Waiting process yet...</span></h2>
                </div>
          
       <%
       
       }
else if(Voterstatus.equalsIgnoreCase("Accepted")){
 %>
          
                  <!----------accepted-------------->  
                  <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">VoterCard Status</h2>
  <h2><span class="label label-primary text-capitalize">Well done! your request is accepted by our department  </span></h2>
                </div>
                
                    <%
}
else if(Voterstatus.equalsIgnoreCase("Generated")){
%>
                      
                          <!----------generated-------------->  
                             <div class="jumbotron text-capitalize text-center">
             <h2 class="panel-heading panel-primary">VoterCard Status</h2>
  <h2><span class="label label-primary text-capitalize">congratulation! your Votercard hasbeen generated, to download</span></h2>
 <a href="DownloadId?cid=<%=cid%>&documentname=VOTER CARD" class=" btn btn-success">click here </a>
                </div>
...
All the document should be verified first otherwise you won't be able to generate any ID 
          ...
          <h2><span class="label label-warning">Your Votercard has been rejected</span></h2>
            <div class="row" >
         <div class="col-lg-12">
        <div class="panel panel-default">
                <div class="panel-heading" align="center"><b><u>Apply for Voter Card</u></b></div>
                ...
                <br>
                   <input type="hidden" name="documentname" value="votercard" ><!-- chk whether
...
All the document should be verified first otherwise you won't be able to generate any ID 
         ...
         <div class="col-md-12">
        <div class="panel panel-default">
                <div class="panel-heading" align="center"><b><u>Apply for VoterCard</u></b></div>
                <div class="panel-body">
                    <form action="SendRequestProcess" role="form" method="post" enctype="multipart/form-data">
                        <div class="col-md-6">
                                <div class="form-group">
