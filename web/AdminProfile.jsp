...
<div class="container-fluid"> 
  ...
  <li role="presentation" ><a data-toggle="tab" href="#EP">Edit Profile</a></li>
            ...
            <div class="col-md-3">
               ...
               <div class="form-group">
                  ...
                  <%
                        ...
                        <label>
                        <input type="radio" name="agen" value="male" checked> Male<br>

                        </label>
              
                        <label>
                        <input type="radio" name="agen" value="female"> Female<br>
                        </label>
               
                        <label>
                         <input type="radio" name="agen" value="other"> Other 
                        </label>
                    </div>   
